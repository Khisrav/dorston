...
<template>
    <div class="border border-sky-900/10 rounded-3xl overflow-hidden shadow-md shadow-sky-800/5">
        ...
        <div class="border-t border-sky-900/10 mx-4 md:mx-4"></div>
        <div class="p-4 md:p-4 pt-3 md:pt-3">
            <slot />
        </div>
    </div>
</template>
